...
> dimensions are 30,463 X 15  

**2. What are the data types of the variables in this dataset?**

<!-- Run the commented code in the load-data chunk to address this question!  -->
> They consist of numbers, characters and dates.  
...
ggplot(data=surveys,
  ...
  labs(title="Hindfoot Length Increases with Weight",
...
#| label: boxplot
ggplot(data=surveys,
       aes(x=species, y= weight, color=species))+
  theme(axis.text.x = element_text(angle=45))+ #https://stackoverflow.com/questions/66689396/customize-ggplot-axis-text 
...
>https://stackoverflow.com/questions/66689396/customize-ggplot-axis-text 
...
ggplot(data=surveys,
       aes(y=species, x= weight, color=species))+
...
> I only needed to find resources for 2 questions.  
